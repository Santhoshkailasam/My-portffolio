...
const LinkedInSection = () => {
  return (
    <section
      id="linkedin"
      className="py-10 md:py-20 px-4 sm:px-10 bg-[#020205] relative overflow-hidden"
    >
      {/* Background Glows */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-full md:h-[600px]">
            ...
            <div className="px-8 pb-8 relative">
              <div className="absolute -top-12 left-8">
                <div className="w-24 h-24 rounded-2xl border-4 border-[#020205] overflow-hidden bg-gray-900 shadow-2xl">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://ui-avatars.com/api/?name=Kailasam+N&background=0077b5&color=fff";
                    }}
                  />
                </div>
              </div>
              <div className="pt-16 space-y-6">
                <div>
                  ...
                  <p className="text-white/60 font-medium italic mt-1">
          ...
          <BentoTile
            className="md:col-span-2 relative overflow-hidden group/cta"
            delay={0.3}
          >
            <div className="relative z-10 flex items-center justify-between gap-6">
              <div className="space-y-2">
                ...
                <p className="text-white/40 text-xs font-medium max-w-[200px]">
                  Currently seeking innovative collaborations in web
                  development.
                </p>
              </div>

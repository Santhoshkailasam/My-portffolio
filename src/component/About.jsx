...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="pt-22 md:pt-22 pb-12 md:pb-20 px-4 md:px-10 overflow-hidden relative"
    >
            ...
            <TiltCard className="relative group">
              ...
              <div className="relative aspect-[4/5] rounded-3xl overflow-hidden premium-glass border border-white/20">
                ...
                <div className="absolute bottom-6 left-6">
                  ...
                  <p className="text-[#C4D613] text-sm font-bold tracking-widest uppercase">
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-white text-3xl font-black mb-8 flex items-center gap-4">
                  ...
                  <Rocket
                    className="text-[#C4D613] float-animation"
                    size={24}
                  />
                </h3>
                ...
                <p className="text-white/70 text-lg leading-relaxed mb-12">
                  ...
                  My approach combines technical precision with a creative eye
